...
class TestFrozenzet(unittest.TestCase):  # noqa
    ...
    def test_pop_exception(self) -> None:
        frozen_zet = frozenzet([1, 2, 3])
    ...
    def test_intersection_update_exception(self) -> None:
        frozen_zet = frozenzet([1, 2, 3])
        frozen_zet2 = frozenzet([4, 5, 6])
    ...
    def test_difference_update_exception(self) -> None:
        frozen_zet = frozenzet([1, 2, 3])
        frozen_zet2 = frozenzet([4, 5, 6])
    ...
    def test_symmetric_difference_update_exception(self) -> None:
        frozen_zet = frozenzet([1, 2, 3])
        frozen_zet2 = frozenzet([4, 5, 6])
